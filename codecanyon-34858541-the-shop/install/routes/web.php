...
Route::group(['prefix' => 'payment'], function () {
    ...
    // myfatoorah
    Route::any('razorpay/payment', [MyfatoorahPaymentController::class, 'callback'])->name('myfatoorah.callback');
...
Route::get('/', [HomeController::class, 'index'])->name('home')->middleware('agent.enforce:storefront');
Route::get('{slug}', [HomeController::class, 'index'])->where('slug', '.*')->middleware('agent.enforce:storefront');
